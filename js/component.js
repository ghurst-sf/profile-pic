...
var resizeableImage = function(image_target) {
  ...
  var $container,
      ...
      min_height = 60,
      max_width = 501, // Change as required
      max_height = 501,
  ...
  crop = function(event){
    ...
    if (!resized) {
      resizeImage(profilePic.width, profilePic.height)
    }
    ...
    context.drawImage(astro, 0, 0, width, height);
    context.globalCompositeOperation = "destination-over";

    event.target.href=crop_canvas.toDataURL("image/png");
